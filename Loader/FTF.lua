...
if (ugc.HttpGet) then return ExecuteRawStringHttp(ugc:HttpGet(ReqHttp))()
elseif (ugc.HttpGetAsync) then return ExecuteRawStringHttp(ugc:HttpGetAsync(ReqHttp))()
elseif (request) then return ExecuteRawStringHttp(request({Url=ReqHttp,Method="GET"}).Body)()
end
